...
% \documentclass[utf8]{test_class} % for testing purposes
...
\textbf{Notice how in the pdf the lines are numbered, even for the section headers, this is because
 the abstract's sections are inside the {\tt abstract} environment}. The lines of the normal
section headers (those in the rest of the file, outside of the abstract environment) are not 
numbered. Also notice how each paragraph is indented, but in the normal sections there is no 
indention. It also seems like the normal sections have a different font face and size.

\section{Objective}\label{abstract_objective}

\textbf{This is in bold letters}. \emph{This is in italics (emph).}\\
This sentence---beginning at the T and ending at the period---has 100 characterss, including spaces.
This sentence---beginning at the T and ending at the period---has 100 characterss, including spaces.
This sentence---beginning at the T and ending at the period---has 100 characterss, including spaces.
...
This sentence---beginning at the T and ending at the period---has 100 characterss, including spaces.
This sentence---beginning at the T and ending at the period---has 100 characterss, including spaces.
\textbf{Notice how the paragraphs are justified, but the last line looks smaller (is that {\tt raggedbottom}? or something like that? ).}\\

\subsection{Sub INTRODUCTION Introduction}\label{} % just to show how the different fonts work for the headings
...
\subsubsection{sub sub INTRODUCTION Introduction}\label{} % just to show how the different fonts work for the headings
